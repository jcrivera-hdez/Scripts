...
"""
Created on Mon Feb 24 10:54:07 2020
@author: jankab

Last version: 2022-01-04
...
for h in range (0,len(Qi)):
    freq=fr[h,0]
    ax.errorbar(n[h],Qi[h], yerr= Qi_err[h], fmt ='o',label=str(np.round(freq*1e-9,3))+' GHz',markersize=10,color = '#6CB0E4')
