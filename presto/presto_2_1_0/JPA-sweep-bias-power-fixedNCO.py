...
# Save data function
def save_data( folder, file, meas_type, myrun, freq, pump_pwr, dc_bias, usb_arr ):
    if not os.path.isdir( folder ):
        os.makedirs( folder )
...
# Save data
save_data(save_folder, save_file, meas_type, myrun, freq_arr+fNCO, amp_pump_arr, bias_arr, usb_arr )
